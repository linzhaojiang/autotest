...
class flyb:
    ...
    #
    #         # 获取jenkins_url
    #         self.job_name = "job/api-test/"  # job名称
    ...
    def ly_data(self):
        ...
        # 获取生成的txt报告数据
        d = {}
        proDir = "/Users/baofu/Documents/API-automation/reports/export/prometheusData.txt"
        f = open(proDir, 'r')
        for lines in f:
            for c in lines:
        ...
        try:
            url_path = 'https://open.feishu.cn/open-apis/bot/v2/hook/3ec5cf22-c0cb-4346-83fc-e6c9a0e91e20'
